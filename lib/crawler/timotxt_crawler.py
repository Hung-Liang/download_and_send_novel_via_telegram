...
class TimotxtCrawler(BasicCrawler):
    """Crawler for https://www.timotxt.com/
    ...
    def __init__(self, url):
        ...
        self.base_url = "https://www.timotxt.com"
    ...
    def get_content(self, index):
        ...
        if soup.find("div", "chapter-content px-3 pb-5").find("h1"):
            chapter_name = (
                soup.find("div", "chapter-content px-3 pb-5")
                .find("h1")
                .text.strip()
            )
